          ...
          <CardContent className='space-y-4'>
            <div className='grid grid-cols-1 gap-3 md:grid-cols-3'>
              <div className='space-y-2'>
                ...
                <Select
                  onValueChange={(value) => setFilterType(value as 'all' | CategoryType)}
                  value={filterType}
                >
                ...
                <>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      value={createType}
                    >
                      <SelectTrigger className='w-full' id='createCategoryType'>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value='expense'>支出</SelectItem>
                ...
                <>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      value={editingStatus}
                    >
                      <SelectTrigger className='w-full' id='editingCategoryStatus'>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value='active'>启用</SelectItem>
